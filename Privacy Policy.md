...
### <a id="ccpa"></a>California Consumer Privacy Act
...
table.pp, table.pp tr, table.pp td, table.pp th {
...
<tr class="ppHeader">
    ...
    <th>Source</th>
    <th>We disclose to:</th>
    <th>We sell to/share with:</th>
</tr>
<tr class="ppContent">
    <td>Identifiers</td>
    <td>
    ...
    <td>You; our social media pages; third party subscription service providers</td>
    <td>Service Providers</td>
    <td>Not sold/shared</td>
</tr>
<tr class="ppContent">
...
<tr class="ppContent">
    <td>Protected Classifications and Other Sensitive Data</td>
    <td>
        <ul>
            <li>Date of Birth</li>
        </ul>
    ...
    <td>Content of Communications</td>
    <td>
        <ul>
